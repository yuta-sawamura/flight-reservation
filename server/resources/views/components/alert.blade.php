<div id="alert" class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative" role="alert">
  <strong class="font-bold">{{ $message }}</strong>
  <span id="deleteElm" class="absolute top-0 bottom-0 right-0 px-4 py-3">
